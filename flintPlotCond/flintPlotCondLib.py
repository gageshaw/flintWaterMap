...
def contourPlot(m, Xcont, Ycont, Zcont):
    ...
    #low readings
    #contourArray = np.arange(.00000001, .05000001 , .0005) 
    #high readings
    #contourArray = np.arange(.1500001, .3500001 , .001) 
    contourArray = np.arange(.0500001, .4000001 , .002)
    #contourArray = np.arange(.0400001, .8500001 , .004)
    #contourArray = np.arange(4.00001, 30.00001 , .2)
    colorList = ['blue'] * 50
