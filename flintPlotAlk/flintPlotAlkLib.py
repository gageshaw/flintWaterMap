...
def contourPlot(m, Xcont, Ycont, Zcont):
    ...
    #contourArray = np.arange(50.0001, 90.0001 , .2)
    contourArray = np.arange(30.0001, 110.0001 , .4)
    #contourArray = np.arange(60.0001, 90.0001 , .5) 
    colorList = ['blue'] * 50
...
def plot3d(dataFile, locationFile):
    Xscat,Yscat,Zscat,Xcont,Ycont,Zcont,T,F = flintLib.readExcel(dataFile, locationFile)
    flintLib.contourScatter3d(Xcont,Ycont,Zcont,Xscat,Yscat,Zscat)
