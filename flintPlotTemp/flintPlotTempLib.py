...
def legend(legendHandles, date, T, F):
    ...
    #Create date box
    plt.annotate( dataType+' - '+date, (200,1500), fontsize=23, fontweight='bold', bbox=dict(facecolor = 'white', alpha = .8,boxstyle='round', edgecolor = '.5'), zorder=10)
